  ...
  <div class="container">
    ...
    <section id="about">
      ...
      <div class="about_wrap">
        <div class="logo"><img src="<?php echo get_template_directory_uri(); ?>/bind/images/logo.svg" alt=""></div>
        <div class="about_content bd">
          <span class="draw"></span>
          <p class="name fade">中村 允</p>
          <p class="introduce fade">1988年、埼玉生まれです。カメラが趣味で、散歩をしながら街の風景を撮影したり、友達の家族写真を撮影したりしています。</p>
          <p class="introduce fade">
            オンラインスクールTechAcademyにて、Webアプリ制作、Webサイト制作、CMS（WordPress）について学習しました。デザインに重点をおきながらも、バックエンドの基礎知識も持つ、フロントエンドエンジニアを目指しています。
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="skills">
      ...
      <div class="skill_wrap">
        ...
        <div class="skill_content bd f_e">
          <span class="draw"></span>
          <h3>Front-end</h3>
          <p class="fade">HTML5, CSS3, Sass(SCSS), gulp,レスポンシブコーディング, jQuery, JavaScript, Dreamweaver</p>
        </div>
      </div>
      <div class="skill_wrap">
        <div class="skill_line"></div>
        <div class="skill_content bd b_e">
          <span class="draw"></span>
          <h3>Back-end</h3>
          <p class="fade">WordPress, PHP, SQL, Ruby, Ruby on Rails</p>
        </div>
      </div>
    </section>
    <!-- /Skills -->
